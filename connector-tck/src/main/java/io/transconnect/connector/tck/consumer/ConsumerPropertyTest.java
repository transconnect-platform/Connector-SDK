...
/**
 * Runs the TCK property checks against every consumer connector registered via the
 ...
 */
public class ConsumerPropertyTest extends AbstractPropertyTest {

    /**
     * {@inheritDoc}
     */
    @ParameterizedTest
    @ArgumentsSource(ConsumerArgumentsProvider.class)
    @Override
