...
/**
 * MockConnector with given list of extentions
 */
@Connector(extensions = {@Extension(MockExtensionFirst.class), @Extension(MockExtensionSecond.class)})
public class MockConnectorWithExtensions implements ConsumerConnector {
    @Override
